...
xcodebuild -project "SquareRegisterSDK.xcodeproj" -scheme "SquarePointOfSaleSDK" -sdk iphonesimulator -configuration Debug -PBXBuildsContinueAfterErrors=0 -destination "platform=iOS Simulator,name=iPad Air 2" ACTIVE_ARCH_ONLY=0 build
